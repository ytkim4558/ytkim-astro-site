---
title: "github.io 예전 링크를 Cloudflare Pages로 넘기는 redirect shim을 만든 기록"
description: "GitHub Pages 루트 URL을 완전히 끊는 대신, 예전 링크 호환을 위해 redirect-only repo를 만들고 Cloudflare Pages canonical을 유지한 기록이다."
pubDate: 2026-06-01
tags:
  - AI Workflow
  - Portfolio
